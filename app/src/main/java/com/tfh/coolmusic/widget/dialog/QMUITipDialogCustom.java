package com.tfh.coolmusic.widget.dialog;
...
public class QMUITipDialogCustom extends QMUIBaseDialog {
    ...
    public static class Builder {
         ...
         */
        public QMUITipDialogCustom.Builder setIconType(@QMUITipDialogCustom.Builder.IconType int iconType) {
         ...
         * 设置显示的文案
         */
        public QMUITipDialogCustom.Builder setTipWord(CharSequence tipWord) {
            mTipWord = tipWord;
            return this;
        }

        public QMUITipDialogCustom.Builder setSkinManager(@Nullable QMUISkinManager skinManager) {
    ...
    public static class CustomBuilder {
        ...
        public QMUITipDialogCustom.CustomBuilder setSkinManager(@Nullable QMUISkinManager skinManager) {
            mSkinManager = skinManager;
            return this;
        }

        public QMUITipDialogCustom.CustomBuilder setContent(@LayoutRes int layoutId) {
