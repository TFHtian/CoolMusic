package com.tfh.commonlibrary.base.fragment
 ...
 */
 abstract class BaseVmDbFragment<VM : BaseViewModel, DB : ViewDataBinding> : Fragment() {
    ...
    private fun registerUiChange() {
        mViewModel.commonChange.showDialog.observeInFragment(this, Observer {
            showLoading(it)
        })
        mViewModel.commonChange.dismissDialog.observeInFragment(this, Observer {
            dismissLoading()
        })
    }
